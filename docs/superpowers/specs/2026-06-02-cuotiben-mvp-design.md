...
- 打印默认输出最终编辑题图，并按题型决定是否增加作答区：选择题和填空题不额外留空，解答题下方留作答区；不默认打印答案解析。
...
- PDF 生成使用 pdf。
- 系统分享和打印使用 printing。
- PDF 版式遵循“练习卷模式”：最终编辑题图 + 按题型生成的解答题作答区。
...
- 错题库支持按学科、年级、时间、标签筛选。
- 错题详情可以生成并查看 AI 答案解析。
- 用户可以选择多道错题生成 PDF，PDF 使用最终编辑题图，并只为解答题增加作答区。
